...
void main() {
  ...
  test('User should login successfully', () {
    httpHelpers.loginRequest('tester8', 'tester8', 'Tester8!').then(
      (response) {
        expect(JwtDecoder.decode(response)['username'], 'tester8');
      },
    );
  ...
  test('User should see password incorrect error', () {
    httpHelpers.loginRequest('tester8', 'tester8', 'Incorrectpassword!').then(
      (response) {
  ...
  test('User should see user does not exist error', () {
    httpHelpers
        .loginRequest(
